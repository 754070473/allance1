	...
	<div id="header">
    	<div class="wrapper">
    		...
    		<ul id="navheader" class="reset">
	    		...
	    		<li class="current"><a rel="nofollow" href="create">发布职位</a></li>
	    		    		</ul>
            	...
            	<dt>
                	...
                	<dd style="display: none;"><a href="jianli">我要找工作</a></dd>
