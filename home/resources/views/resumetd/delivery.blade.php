    		...
    		<ul id="navheader" class="reset">
            	...
            	<dt>
            		...
            		<i></i>
                                	...
                                	<dd style="display: none;"><a rel="nofollow" href="jianli">我的简历</a></dd>
                	                	<dd style="display: none;"><a href="collections">我收藏的职位</a></dd>
                	                	                	<dd style="display: none;"><a href="toudi">我投递的职位 <span id="noticeNo" class="red dn">(0)</span></a></dd>
                	                	<dd class="btm" style="display: none;"><a href="subscribe">我的订阅</a></dd>
                	<dd style="display: none;"><a href="create">我要招人</a></dd>
        ...
        <div class="clearfix">
            	...
            	<dl class="c_delivery">
                    ...
                    <dd>
                    	<div class="delivery_tabs">
                    		<ul class="reset">
                    			                    			<li class="current">
                    				<a href="delivery?tag=-1">全部</a>
                    			</li>
                    			                    			<li>
                    				<a href="delivery?tag=5">投递成功</a>
                    			</li>
                    			<li>
                    				<a href="delivery?tag=1">被查看</a>
                    			</li>
                    			<li>
                    				<a href="delivery?tag=2">通过初筛</a>
                    			</li>
                    			<li>
                    				<a href="delivery?tag=3">通知面试</a>
                    			</li>
                    			<li class="last">
                    				<a href="delivery?tag=4">不合适</a>
                    			</li>
                    		</ul>
                    	</div>
                            ...
                            <ul class="reset my_delivery">
                             		...
                             		<div class="d_item">
                             			 	                                    <h2 title="随便写">
	                                        <a target="_blank" href="http://www.lagou.com/jobs/149594">
	                                        	<em>随便写</em> 
	                                        	<span>（1k-2k）</span>
	                                        	<!--  -->
	                                    	</a>
	                                    		                                ...
	                                    		                                <div class="clear"></div>
	                                   	<a title="公司名称" class="d_jobname" target="_blank" href="http://www.lagou.com/c/25927">
	                                   		公司名称 <span>[上海]</span> 
	                                    </a>
            ...
            <div class="content_r">
            	<div class="mycenterR" id="myInfo">
            		...
            		<br>
            		            		<a href="toudi" target="_blank">我投递的职位<span id="noticeNoPage" class="red dn">&nbsp;(0)</span></a>
            		<br>
            		            		<a target="_blank" href="subscribe">我订阅的职位</a>
            		            		<br>
            		<a target="_blank" href="mList">我的职位推荐</a>
            		            	</div><!--end #myInfo-->
            					<div class="mycenterR" id="myRecommend">
            		<h2>可能适合你的职位 <i>匹配度</i></h2>
            		<ul class="reset">
            			            			<li>
            				<a target="_blank" href="http://www.lagou.com/jobs/22194">
								...
								<em>92%</em>
            			            			...
            			            			<li>
            				<a target="_blank" href="http://www.lagou.com/jobs/148004">
								<span class="f16">产品经理</span>
								...
								<em>92%</em>
            			            			...
            			            			<li>
            				<a target="_blank" href="http://www.lagou.com/jobs/46793">
								<span class="f16">产品经理</span>
								...
								<em>89%</em>
            			            			...
            			            			<li>
            				<a target="_blank" href="http://www.lagou.com/jobs/99307">
								<span class="f16">产品经理</span>
								...
								<em>88%</em>
            			            			...
            			            			<li>
            				<a target="_blank" href="http://www.lagou.com/jobs/147510">
								<span class="f16">产品经理</span>
