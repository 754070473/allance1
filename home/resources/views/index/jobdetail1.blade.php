	...
	<div id="header">
    	<div class="wrapper">
    		...
    		<ul id="navheader" class="reset">
    			...
    			<li><a target="_blank" href="toForum">论坛</a></li>
                    ...
                    <dt>
                        <h1 title="web前端开发">
                            <em></em>
                       			...
                       			<span>已成功收藏该职位，</span>
								<a class="jd_collection_page" href="mycenter/collections">查看全部</a>								
...
<br>6、熟悉互联网，具有积克精神，精通设计美学，可做设计者优先。&nbsp;
				                        ...
				                        <div style="width:400px;">
								          <span> 你已设置默认投递简历：<a title="jason的简历" target="_blank" href="resume/myresume"><strong>在线简历：jason的简历</strong></a></span><br>
            ...
            <div class="content_r">
                <dl class="job_company">
            		...
            		<ul class="reset">
            			            			<li>
            				<a target="_blank" href="jobs/22194">
								...
								<em>92%</em>
            			            			...
            			            			<li>
            				<a target="_blank" href="jobs/148004">
								<span class="f14">产品经理</span>
								...
								<em>92%</em>
            			            			...
            			            			<li>
            				<a target="_blank" href="jobs/46793">
								<span class="f14">产品经理</span>
								...
								<em>89%</em>
            			            			...
            			            			<li>
            				<a target="_blank" href="jobs/99307">
								<span class="f14">产品经理</span>
								...
								<em>88%</em>
            			            			...
            			            			<li>
            				<a target="_blank" href="jobs/147510">
								<span class="f14">产品经理</span>
								...
								<em>88%</em>
            		            		...
            		            		<a target="_blank" class="more" href="mList">更多推荐职位&gt;&gt;</a>
            		            	</div><!--end #myRecommend-->
				                <a class="eventAd" target="_blank" href="subject/s_zhouyou?utm_source=BD__lagou&amp;utm_medium=&amp;utm_campaign=zhouyou">
	    	...
	    	<tr>
	        	<td>
                    <form class="resumeSetForm" id="resumeSetForm">
            			...
            			<div class="setBtns">
            					            				<a target="_blank" href="resume/preview">预览</a> |
	            										<a target="_blank" href="resume/myresume">修改</a>
            			</div>
	            		<div class="clear"></div>
	            		<label class="radio">
...
<!-- 投递简历时  - 设置默认投递简历 -->
	...
	<div style="height:240px;" class="popup" id="loginPop">
       	<form id="loginForm">
		    ...
		    <a class="fr" href="reset">忘记密码？</a>
		    <input type="submit" value="登 &nbsp; &nbsp; 录" id="submitLogin">
		</form>
		<div class="login_right">
			<div>还没有拉勾帐号？</div>
			<a class="registor_now" href="register">立即注册</a>
		    <div class="login_others">使用以下帐号直接登录:</div>
		    <a title="使用新浪微博帐号登录" class="icon_wb" target="_blank" href="ologin/auth/sina"></a>
		    <a title="使用腾讯QQ帐号登录" target="_blank" class="icon_qq" href="ologin/auth/qq"></a>
		</div>
    </div><!--/#loginPop-->
        ...
        <table width="100%">
            <tbody><tr class="drawGGJ">
                <td align="center">
                	...
                	<p class="font_16 share dn">邀请好友成功注册拉勾，可提升每日投递量 &nbsp;&nbsp; <a target="_blank" href="share/invite">邀请好友&gt;&gt;</a></p>
                </td>
            </tr>
        	<tr class="drawQD">
            	<td align="center"><a class="btn_s" href="javascript:top.location.reload();">确&nbsp;定</a></td>
	    	...
	    	<tr>
	        	<td align="center">
                   <form>
                    ...
                    <a target="_blank" href="resume/basic" class="btn">完善在线简历</a>
	            </td>
	        </tr>
	    </tbody></table>
	</div><!--/#sendNoResume-->
	...
	<div style="height:240px;" class="popup" id="activePop">
       	...
       	<p>我们已将验证邮件发送至：<a>840389046@qq.com</a>，请点击邮件内的链接完成验证。</p>
                <p><a id="resend" href="javascript:void(0)">重新发送验证邮件 </a> | <a target="_blank" href="register"> 换个邮箱？ </a>  	</p>
    </div><!--/#activePop-->    
...
var options = {
    	...
    	"merchantId": "11253",
    	"merchantType": "news",
    	"socialLoginUrl_sina": ctx+"/ologin/auth/sina",
    	"socialLoginUrl_qq": "",
    	"weiboId_sina": "3619164344010985",
    	"weiboId_qq": "",
    	"socialAllUrl": ctx+"/user/hbzx",
    	"productId": "149487",
    	"productCategory": "",
    	"productName": "web前端开发",
    	"productArea": "广州",
    	"productPrice": "",
    	"productUrl": ctx+"/jobs/149487",
...
<script type="text/javascript">
	...
	<div id="footer">
		<div class="wrapper">
		    ...
		    <a target="_blank" href="af/zhaopin">互联网公司导航</a>
		...
		init:function(url){
			...
			_websocket.onmessage = function(evt) {
				...
				if(notice.status[0] == 0){
					...
					$('#noticeTip').show();
					$('#noticeNo').text('('+notice.status[0]+')').show().parent('a').attr('href',ctx+'/mycenter/delivery?tag=0&amp;r=0');
					$('#noticeNoPage').text(' ('+notice.status[0]+')').show().parent('a').attr('href',ctx+'/mycenter/delivery?tag=0&amp;r=0');
				}
				$('#noticeDot-1').hide();
			};
