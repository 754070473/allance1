...
<title>公司预览-拉勾网-最专业的互联网招聘平台</title>
...
<body>
	@foreach ($ar as $key => $user)
		
	
  	<div id="previewWrapper">
        <div class="preview_header">
            <h1 title="jason的简历">{{$user->m_name}}</h1>
                        	<a title="下载简历" class="inline cboxElement" href="#downloadOnlineResume">下载该公司信息</a>
		...
		<div class="profile_box" id="selfDescription">
	              ...
	              <li class="noborder">
	            	...
	            	<div class="f16"> {{$user->m_place}} </div>
	            <p>产品 </p>
	            	</div>
            				</li>
            		</ul>
