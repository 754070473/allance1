    ...
    <div id="container">
      ...
      <input type="hidden" value="" id="positionLat" />
		...
		<div>
			...
			<div class="right">
				<a href="register?from=jobs_footerbar" onclick="_hmt.push(['_trackEvent', 'button', 'click', 'register'])" class="bar_register" id="bar_register" target="_blank"><i></i></a>
			</div>
...
<!-- 投递简历时  - 设置默认投递简历 -->
        ...
        <table width="100%">
            <tr class="drawGGJ">
                <td align="center">
                	...
                	<p class="font_16 share dn">邀请好友成功注册拉勾，可提升每日投递量 &nbsp;&nbsp; <a href="h/share/invite" target="_blank">邀请好友>></a></p>
                </td>
            </tr>
        	<tr class="drawQD">
            	<td align="center"><a href="javascript:top.location.reload();" class="btn_s">确&nbsp;定</a></td>
	    	...
	    	<tr>
	        	<td align="center">
                   <form>
                    ...
                    <a class="btn" href="jianli" target="_blank">完善在线简历</a>
	            </td>
	        </tr>
	    </table>
	</div><!--/#sendNoResume-->
	...
	<div id="activePop" class="popup" style="height:240px;">
       	...
       	<p>我们已将验证邮件发送至：<a></a>，请点击邮件内的链接完成验证。</p>
                <p><a href="javascript:void(0)" id="resend">重新发送验证邮件 </a> | <a href="register" target="_blank"> 换个邮箱？ </a>  	</p>
    </div><!--/#activePop-->    
