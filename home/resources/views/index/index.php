...
<frameset rows="*" cols="*" scrolling="No" framespacing="0"
	frameborder="no" border="0"> 
	<frame src="main" name="headmenu" id="mainFrame" title="mainFrame" >

	<!-- <frameset rows="80*" cols="100%"  framespacing="0" frameborder="no" border="0">
...
引用左边和主体部分 
	...
	<frameset rows="80*" cols="220,*"  framespacing="0" frameborder="no" border="0">
