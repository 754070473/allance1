    	...
    	<div class="wrapper">
    		...
    		<ul id="navheader" class="reset">
            	...
            	<dt>
                	...
                	<dd style="display: none;"><a href="list">我要找工作</a></dd>
                                                <dd style="display: none;"><a href="accountBind">帐号设置</a></dd>
                                <dd class="logout" style="display: none;"><a rel="nofollow" href="login">退出</a></dd>
            </dl>
                                </div>
    </div><!-- end #header -->
    <div id="container">
                    ...
                    <dt>
                        <h1 title="产品经理">
                            <em></em>
                       			...
                       			<span>已成功收藏该职位，</span>
								<a class="jd_collection_page" href="collections">查看全部</a>								
...
<p>3、每周定期举办足球、羽毛球、篮球及员工深度互动等文体活动。</p>
				                        ...
				                        <div>
								          <span> 你已有可投递的在线简历：<a title="jason的简历" target="_blank" href="jianli"><strong>jason的简历</strong></a></span><br>
								          <span>简历更新于2014-07-01 15:53</span>
				                        </div>
				                        <span class="setBtns">
				                        	<a target="_blank" title="预览" href="h/resume/preview">预览</a> |
				                        	<a title="修改" target="_blank" href="jianli">修改</a>
				                        </span>
				                    </dd>
            ...
            <div class="content_r">
                <dl class="job_company">
            		...
            		<ul class="reset">
            			            			<li>
            				<a target="_blank" href="h/jobs/148004">
								...
								<em>92%</em>
            			            			...
            			            			<li>
            				<a target="_blank" href="h/jobs/46793">
								<span class="f14">产品经理</span>
								...
								<em>89%</em>
            			            			...
            			            			<li>
            				<a target="_blank" href="h/jobs/99307">
								<span class="f14">产品经理</span>
								...
								<em>88%</em>
            			            			...
            			            			<li>
            				<a target="_blank" href="h/jobs/147510">
								<span class="f14">产品经理</span>
								...
								<em>88%</em>
            			            			...
            			            			<li>
            				<a target="_blank" href="h/jobs/146995">
								<span class="f14">产品经理</span>
								...
								<em>87%</em>
            		            		...
            		            		<a target="_blank" class="more" href="h/jobs/mList">更多推荐职位&gt;&gt;</a>
            		            	</div><!--end #myRecommend-->
				                <a class="eventAd" target="_blank" href="h/subject/s_zhouyou?utm_source=BD__lagou&amp;utm_medium=&amp;utm_campaign=zhouyou">
	    	...
	    	<tr>
	        	<td>
                    <form class="resumeSetForm" id="resumeSetForm">
            			...
            			<div class="setBtns">
            					            				<a target="_blank" href="h/resume/preview">预览</a> |
...
<!-- 投递简历时  - 设置默认投递简历 -->
	...
	<div style="height:240px;" class="popup" id="loginPop">
       	<form id="loginForm">
		    ...
		    <a class="fr" href="h/reset">忘记密码？</a>
		...
		<div class="login_right">
		    ...
		    <a title="使用新浪微博帐号登录" class="icon_wb" target="_blank" href="h/ologin/auth/sina"></a>
		    <a title="使用腾讯QQ帐号登录" target="_blank" class="icon_qq" href="h/ologin/auth/qq"></a>
		</div>
    </div><!--/#loginPop-->
        ...
        <table width="100%">
            <tbody><tr class="drawGGJ">
                <td align="center">
                	...
                	<p class="font_16 share dn">邀请好友成功注册拉勾，可提升每日投递量 &nbsp;&nbsp; <a target="_blank" href="h/share/invite">邀请好友&gt;&gt;</a></p>
                </td>
            </tr>
        	<tr class="drawQD">
            	<td align="center"><a class="btn_s" href="javascript:top.location.reload();">确&nbsp;定</a></td>
	    	...
	    	<tr>
	        	<td align="center">
                   <form>
                    ...
                    <a target="_blank" href="jianli" class="btn">完善在线简历</a>
	            </td>
	        </tr>
	    </tbody></table>
	</div><!--/#sendNoResume-->
