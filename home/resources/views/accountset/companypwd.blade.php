...
<div id="cache" style="padding-bottom:20px;">
    ...
    <dl id="user_sideBarmenu" class="user_sideBarmenu">
     	        <dt><h3>帐号设置</h3></dt>
                <dd><a href="accountBind">帐号绑定</a></dd>
        <dd><a class="hover" href="companypwdl">修改密码</a></dd>
            </dl>
</div>
        ...
        <dl class="c_section">
            ...
            <dd>
                    ...
                    <table class="savePassword">
            			<tbody><tr>
            				<td>登录用户</td>
            				<td class="c7">@if(session('c_phone'))
                             <?php  
                             $aa=session('c_phone');
                            echo "$aa";
                             ?>
            			...
            			<tr>
            				...
            				<td>
            					<input type="password" value="" maxlength="16" id="oldpassword" name="oldpassword" style="background-image: url(style/images/img/0CQnd2Jos49xUAAAAASUVORK5CYII=quot); background-repeat: no-repeat; background-attachment: scroll; background-position: right center;" onblur="company()">
...
<div style="display:none;">
     	...
     	<table>
         	...
         	<tr>
         		<td align="center"> 
         			...
         			<a class="cancel" href="login">退出当前帐号</a>
         		</td>
         	</tr>
        </tbody></table>
    </div><!--/#bindTips-->
   ...
   <div class="popup user_popup" id="confirmUnbind">
	...
	<div style="overflow:hidden" class="popup" id="unbindService">
		...
		<a class="btn" href="h/corpCenter/bindStep1">立即跳转</a>
	</div>
...
<script src="style/js/setting2.js"></script>
			<div class="clear"></div>
...
function company(){
    ...
    $.ajax({
        ...
        if(msg==1){
            ...
            $('#updatePwd_beError').html('');
            } else{
            $('#updatePwd_beError').show();
            $('#updatePwd_beError').html('密码不正确');
          }
        }
    });
}
...
//         type: "GET",
//         url: "{{url('companypwd')}}",
//         data: "comfirmpassword="+comfirmpassword,
