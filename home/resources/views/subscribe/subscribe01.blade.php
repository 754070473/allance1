...
<div style="display:none;">	
	...
	-->
		<div class="popup" id="subscribeSuccessLogined">
            ...
            <table width="100%">
            	<tbody><tr>
                	<td align="center"><a class="btn_s" href="subscribe">确&nbsp;定</a></td>
                </tr>
            </tbody></table>
	                ...
	                <tr>
	                	...
	                	<td>
	                		<label for="checkbox" class="fl">
	                			...
	                			我已阅读并同意<a target="_blank" href="http://www.lagou.com/privacy">《拉勾用户协议》</a>
	                		</label>
	                	</td>
	                </tr>
	            	<tr>
	...
	<div style="height:240px;" class="popup" id="loginPop">
       	<form id="loginForm">
		    ...
		    <a target="_blank" class="fr" href="http://www.lagou.com/reset">忘记密码？</a>
		    <input type="submit" value="登 &nbsp; &nbsp; 录" id="submitLogin">
		</form>
		<div class="login_right">
			<div>还没有拉勾帐号？</div>
			<a class="registor_now" href="http://www.lagou.com/register">立即注册</a>
		    <div class="login_others">使用以下帐号直接登录:</div>
		    <a title="使用新浪微博帐号登录" class="icon_wb" target="_blank" href="http://www.lagou.com/ologin/auth/sina"></a>
		    <a title="使用腾讯QQ帐号登录" target="_blank" class="icon_qq" href="http://www.lagou.com/ologin/auth/qq"></a>
		</div>
    </div><!--/#loginPop-->
