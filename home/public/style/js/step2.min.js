$(function() {
    $("#labels").on("mouseenter", "li",
    function() {
        $(this).find("i").addClass("visible")
    }),
    $("#labels").on("mouseleave", "li",
    function() {
        $(this).find("i").removeClass("visible")
    }),
    $("#labels").on("click", "li i",
    function() {
    ...
    function() {
        ...
        }), c ? $("#labels").append("<li><span>" + b + "</span><i></i></li>") : alert("此标签已存在，请从新输入")) : alert("请输入1-6字的自定义标签"),
        a.val("")
    }),
    $("#label").keydown(function(a) {
        13 == a.which && (a.stopPropagation(), $("#add_label").trigger("click"))
    }),
    $("#box_labels").on("click", "li",
    function() {
