...
$(function() {
    ...
    function(a) {
        ...
        $(this).parents("#box_age").hide().siblings("#age").val(b),
        $("#jobForm").validate().element($("#age"))
    }),
